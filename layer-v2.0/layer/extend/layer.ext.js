            ...
            function(c) {
                ...
                f.index = layer.open($.extend({
                    ...
                    area: areas = function() {
                        ...
                        return ! a.full && b[0] > d[0] && (b[1] = b[1] * d[0] / b[0], b[0] = d[0]) && b[1] > d[1] && (b[0] = b[0] * d[1] / b[1], b[1] = d[1]),
                        [b[0] + "px", b[1] + "px"]
                    } (),
                    title: !1,
                    shade: .9,
                    ...
                    content: '<div class="layui-layer-phimg"><img src="' + i[j].src + '" height="' + areas[1] + '" width="' + areas[0] + '" alt="' + (i[j].alt || "") + '" layer-pid="' + i[j].pid + '"><div class="layui-layer-imgsee">' + (i.length > 1 ? '<span class="layui-layer-imguide"><a href="javascript:;" class="layui-layer-iconext layui-layer-imgprev"></a><a href="javascript:;" class="layui-layer-iconext layui-layer-imgnext"></a></span>': "") + '<div class="layui-layer-imgbar" style="display:' + (d ? "block": "") + '"><span class="layui-layer-imgtit"><a href="javascript:;">' + (i[j].alt || "") + "</a><em>" + f.imgIndex + "/" + i.length + "</em></span></div></div></div>",
